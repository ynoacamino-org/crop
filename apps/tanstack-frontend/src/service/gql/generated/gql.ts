...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateArticle(variables: CreateArticleMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateArticleMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateArticleMutation>({ document: CreateArticleDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateArticle', 'mutation', variables);
    },
    ...
    UpdateArticleStatus(variables: UpdateArticleStatusMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateArticleStatusMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateArticleStatusMutation>({ document: UpdateArticleStatusDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateArticleStatus', 'mutation', variables);
    },
    DeleteArticle(variables: DeleteArticleMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteArticleMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteArticleMutation>({ document: DeleteArticleDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteArticle', 'mutation', variables);
    },
    CreateCaseType(variables: CreateCaseTypeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateCaseTypeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateCaseTypeMutation>({ document: CreateCaseTypeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateCaseType', 'mutation', variables);
    },
    UpdateCaseType(variables: UpdateCaseTypeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateCaseTypeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateCaseTypeMutation>({ document: UpdateCaseTypeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateCaseType', 'mutation', variables);
    },
    DeleteCaseType(variables: DeleteCaseTypeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteCaseTypeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteCaseTypeMutation>({ document: DeleteCaseTypeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteCaseType', 'mutation', variables);
    },
    CreateMedia(variables: CreateMediaMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CreateMediaMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateMediaMutation>({ document: CreateMediaDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CreateMedia', 'mutation', variables);
    },
    UpdateMedia(variables: UpdateMediaMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<UpdateMediaMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UpdateMediaMutation>({ document: UpdateMediaDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'UpdateMedia', 'mutation', variables);
    },
    DeleteMedia(variables: DeleteMediaMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteMediaMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteMediaMutation>({ document: DeleteMediaDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'DeleteMedia', 'mutation', variables);
    },
    ...
    deleteMe(variables?: DeleteMeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<DeleteMeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<DeleteMeMutation>({ document: DeleteMeDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'deleteMe', 'mutation', variables);
    },
    ...
    AdminArticles(variables?: AdminArticlesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AdminArticlesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<AdminArticlesQuery>({ document: AdminArticlesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'AdminArticles', 'query', variables);
    },
    AdminStats(variables?: AdminStatsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<AdminStatsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<AdminStatsQuery>({ document: AdminStatsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'AdminStats', 'query', variables);
    },
    Article(variables: ArticleQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ArticleQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ArticleQuery>({ document: ArticleDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Article', 'query', variables);
    },
    ArticleById(variables: ArticleByIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ArticleByIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ArticleByIdQuery>({ document: ArticleByIdDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'ArticleById', 'query', variables);
    },
    RecentArticles(variables?: RecentArticlesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<RecentArticlesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RecentArticlesQuery>({ document: RecentArticlesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'RecentArticles', 'query', variables);
    },
    CaseTypes(variables?: CaseTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CaseTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CaseTypesQuery>({ document: CaseTypesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'CaseTypes', 'query', variables);
    },
    ...
    LegalCase(variables?: LegalCaseQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<LegalCaseQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LegalCaseQuery>({ document: LegalCaseDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'LegalCase', 'query', variables);
    },
    RecentLegalCases(variables?: RecentLegalCasesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<RecentLegalCasesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<RecentLegalCasesQuery>({ document: RecentLegalCasesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'RecentLegalCases', 'query', variables);
    },
    Medias(variables?: MediasQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<MediasQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<MediasQuery>({ document: MediasDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Medias', 'query', variables);
    },
