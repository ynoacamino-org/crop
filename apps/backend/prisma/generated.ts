/* eslint-disable */
import type { Prisma, User, Session, Account, Verification, Media, Article, LegalCase, Court, Category, Tag, CaseType } from "./client/client.js";
...
export default interface PrismaTypes {
    ...
    LegalCase: {
        ...
        Create: {};
        Update: {};
        RelationName: "court" | "caseType" | "articles";
    ...
    CaseType: {
        Name: "CaseType";
        Shape: CaseType;
        Include: Prisma.CaseTypeInclude;
        Select: Prisma.CaseTypeSelect;
        OrderBy: Prisma.CaseTypeOrderByWithRelationInput;
        WhereUnique: Prisma.CaseTypeWhereUniqueInput;
        Where: Prisma.CaseTypeWhereInput;
        Create: {};
        Update: {};
        RelationName: "legalCases";
        ListRelations: "legalCases";
        Relations: {
            legalCases: {
                Shape: LegalCase[];
                Name: "LegalCase";
