/* eslint-disable */
import type { Prisma, User, Session, Account, Verification, Media } from "./client/client.js";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "sessions" | "accounts" | "media";
        ListRelations: "sessions" | "accounts" | "media";
        Relations: {
            sessions: {
                Shape: Session[];
                Name: "Session";
