...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "sessions" | "accounts";
        ListRelations: "sessions" | "accounts";
        Relations: {
            sessions: {
                Shape: Session[];
                Name: "Session";
