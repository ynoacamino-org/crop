/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57b406e7dec6a1bb10f75b2b3282617a)
// Runtime types generated with workerd@1.20260616.1 2026-06-18 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	MY_BUCKET: R2Bucket;
	DB: D1Database;
	DEV_SEED_TOKEN: "dev-seed-token-change-me";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entries/edge");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_SEED_TOKEN">> {}
}
