...
export const createArticleSchema = z.object({
  ...
  excerpt: z.string().max(500, { message: "El extracto no puede tener más de 500 caracteres" }).optional(),
  content: z
...
export const updateArticleSchema = z.object({
  ...
  slug: z
    ...
    .optional(),
  excerpt: z.string().max(500, { message: "El extracto no puede tener más de 500 caracteres" }).optional(),
  content: z.string().min(50, { message: "El contenido debe tener al menos 50 caracteres" }).optional(),
  status: ArticleStatus.optional(),
  readingTimeMin: z.number().int().positive().optional(),
